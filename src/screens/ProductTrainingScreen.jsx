...
const ProductTrainingScreen = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View>
            <Text style={styles.headerTitle}>Product Training</Text>
            <Text style={styles.headerSubtitle}>Learn about our product range</Text>
          </View>
        </View>
      ...
      <View style={styles.breadcrumb}>
        ...
        <Text style={styles.breadcrumbActive}>Product Training</Text>
      </View>
            ...
            >
              <View style={styles.cardContent}>
                ...
                <View style={styles.cardInfo}>
                  ...
                  <Text style={styles.moduleCount}>{module.moduleCount} modules</Text>
...
export default ProductTrainingScreen;